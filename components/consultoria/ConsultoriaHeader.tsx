...
interface ConsultoriaHeaderProps {
	spotsLeft: number;
}

const items: readonly NavbarItem[] = [
	{ href: "#como", label: "Cómo trabajamos" },
	{ href: "#diagnostico", label: "El Diagnóstico" },
...
const CTA = (): ReactElement => (
	<Button size="sm" variant="accent" asChild>
		<Link href="#cta">Agendar reunión</Link>
	</Button>
);
...
export function ConsultoriaHeader({ spotsLeft }: ConsultoriaHeaderProps): ReactElement {
	return (
		<Navbar.Root theme="onyx" anchors={anchors} ariaLabel="Consultoría">
			<Navbar.Brand>
				<Brand />
			</Navbar.Brand>
